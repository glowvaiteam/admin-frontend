...
// Admin handle for display
const ADMIN_HANDLE = "admin@glowvai.in";

function AdminDashboard() {
  const navigate = useNavigate();

  // Protect route: Only allow if admin is logged in
  useEffect(() => {
...
setTotalAnalysings(total);
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      {/* Admin handle display */}
      <div className="bg-gray-100 p-2 text-right text-sm text-gray-600">Logged in as <span className="font-bold">{ADMIN_HANDLE}</span></div>
      {/* ================= HEADER ================= */}
